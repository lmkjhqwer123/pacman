...
public class Board extends JPanel
{
 //setting hình ảnh cho trò chơi 
  ...
  Image pacmanLeftImage = Toolkit.getDefaultToolkit().getImage("src/img/pacmanleft.jpg"); 
  Image pacmanRightImage = Toolkit.getDefaultToolkit().getImage("src/img/pacmanright.jpg"); 
  Image ghost10 = Toolkit.getDefaultToolkit().getImage("src/img/ghost10.jpg"); 
  Image ghost20 = Toolkit.getDefaultToolkit().getImage("src/img/ghost20.jpg"); 
  Image ghost30 = Toolkit.getDefaultToolkit().getImage("src/img/ghost30.jpg"); 
  Image ghost40 = Toolkit.getDefaultToolkit().getImage("src/img/ghost40.jpg"); 
  Image ghost11 = Toolkit.getDefaultToolkit().getImage("src/img/ghost11.jpg"); 
  Image ghost21 = Toolkit.getDefaultToolkit().getImage("src/img/ghost21.jpg"); 
  Image ghost31 = Toolkit.getDefaultToolkit().getImage("src/img/ghost31.jpg"); 
  Image ghost41 = Toolkit.getDefaultToolkit().getImage("src/img/ghost41.jpg"); 
  Image titleScreenImage = Toolkit.getDefaultToolkit().getImage("src/img/titleScreen.jpg"); 
